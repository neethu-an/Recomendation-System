 ...
 */
public class RatingInformation extends javax.swing.JFrame {
    ...
    public int loaddata() {
        ...
        try {
            ...
            JOptionPane.showMessageDialog(null, "Rating information loaded successfully");
        } catch (Exception e) {
            System.out.println(e);
            e.printStackTrace();
        }
    ...
    public void viewdata() {
        try {
            String r;
            jTextArea1.append("Userid\tMovieid\tRating\tTimestamp\n");
            FileReader fr=new FileReader("./Files/replaced2.txt");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RatingInformation.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new RatingInformation().setVisible(true);
            }
        });
    }
